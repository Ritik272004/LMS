...
const CourseDetails = () => {
  ...
  const {allCourses , calculateRating , calculateChapterDuration,calculateCourseDuration,calculateNoOfLectures , currency} = useContext(AppContext)
  ...
  return courseData ? (
    ...
    px-8 md:pt-30 pt-20 text-left'>
      ...
      <div className='max-w-xl z-10 text-gray-500'>
        ...
        <p className='text-sm'>Course by <span className='text-blue-600 underline'>RitikStack</span> </p>

        <div className='pt-8 text-gray-800'>
            <h2 className='text-4xl font-semibold'>Course Structure</h2>
            <div className='pt-5'>
              {courseData.courseContent.map((chapter , index)=> (
                <div key={index} className='border border-gray-300 bg-white mb-2 rounded'>
                   ...
                   ' onClick={()=>toggleSection(index)} >
                    ...
                    <p className='text-sm md:text-default'>{chapter.chapterContent.length} lectures - {calculateChapterDuration(chapter)}
                    </p>
                  </div>
                        ...
                        <li key = {i} className='flex items-start gap-2 py-1'>
                          ...
                          <div className='flex items-center justify-between w-full text-gray-800 text-xs md:text-default'>
                            ...
                            <div className='flex gap-2' >
                              ...
                              <p>{humaniseDuration(lecture.lectureDuration * 60 * 1000 , {units : ["h","m"]})}</p>
                            </div>
                          </div>
                        </li>
                      ))}
      ...
      {/* right column */}
      <div className='max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[200px]'>
        {
          playerData ? 
        ...
        <div className='p-5'>
            ...
            <div className='flex gap-3 items-center pt-2'>
                <p className='text-gray-800 md:text-4xl tet-2xl font-semibold'>
                  {currency}{(courseData.coursePrice - courseData.coursePrice / 100).toFixed(2)}
                </p>
