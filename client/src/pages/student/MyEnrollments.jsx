...
userData , fetchUserEnrolledCourses , backendUrl , getToken , calculateNoOfLectures} = useContext(AppContext)
  ...
  const getCourseProgress = async ()=>{
    try {
      ...
      const tempProgressArray = await Promise.all(/**Promise.all() → ensures all those async calls run in parallel, and only when all are done, the result (tempProgressArray) is returned. This is faster than waiting one by one. */
