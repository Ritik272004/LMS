...
const Player = () => {
  ...
  const {enrolledCourses , calculateChapterDuration , backendUrl , getToken , userData , fetchUserEnrolledCourses} = useContext(AppContext);
  ...
  const markLectureAsCompleted = async (lectureId)=>{
    try {
      const token = await getToken() // This token is send in API Request
